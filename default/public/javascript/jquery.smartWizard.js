...
function SmartWizard(target, options) {
    ...
    var _init = function($this) {
        ...
        $($this.buttons.next).click(function() {
            //$this.curStepIdx = 0 es la primera pantalla
            if($this.curStepIdx == 0){
                 
                actualizarProveedor();
                //aqui si no es reuturn entonces carga la lista
                ...
                */
                ...
                //var idprov = $("#bt_accion").val();
                //var idprov = $("#operacion").html();
            ...
            data: "idprod=" + idprod + "&idprov=" + idprov,
            //success: cargarDatos
